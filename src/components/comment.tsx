...
export function Comment({ content, onDeleteComment }: IComment) {
  ...
  function handleLikeComment() {
    setLikeCount((likeCountActuallyValue) => {
      return likeCountActuallyValue + 1;
    });
  }

  return (
    <div className="flex items-start gap-2 lg:gap-4">
      <Avatar githubURL="https://live.staticflickr.com/65535/54331543968_35955063b7_o.png" />
          ...
          <header className="flex items-start">
            <div>
              <h3 className="text-sm font-roboto-bold font-bold text-woodsmoke-200">
                FitGuru <span className="text-woodsmoke-400">(bot)</span>
              </h3>
              <time
